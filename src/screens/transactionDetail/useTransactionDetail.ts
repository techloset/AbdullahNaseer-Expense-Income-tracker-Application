...
const useTransactionDetail = (transactionData: TransactionInterface): TransactionDetailHook => {
  ...
  const handleDelete = async (transactionType: string, docId: string): Promise<void> => {
    try {
